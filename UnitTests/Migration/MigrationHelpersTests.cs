...
namespace UnitTests.Migration
{
    ...
    public class MigrationHelpersTests
    {
        ...
        public void GetInlineImageHtmlTags_ReturnsEmptyHashSetWhenAccountUrlDoesNotMatch()
        {
            ...
            var actual = MigrationHelpers.GetInlineImageHtmlTags(input, "https://dev.azure.com/account2");
            Assert.IsTrue(actual.Count == 0);
        }
        ...
        public void GetInlineImageHtmlTags_ReturnsCorrectValueForNoInlineImageHtmlTag()
        {
            ...
            var actual = MigrationHelpers.GetInlineImageHtmlTags(input, "https://dev.azure.com/account");
        ...
        [TestMethod]
        public void GetInlineImageHtmlTags_ReturnsCorrectValueForOneProjectScopedInlineImageHtmlTag()
        {
            string input = "In the workItemRelations api, we return link information, but do not tell them if it's a forward/reverse link, nor do we tell them what the opposite direction of the link is.<div><br></div><div>This is handy information to know so that consumers don't have to do string parsing based on if the reference name ends in -Forward/-Reverse to figure it out.</div><div><br></div><div><img src=\"https://dev.azure.com/account/bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb/_apis/wit/attachments/aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa?fileName=temp1498074488622.png\" style=\"width:779.45px;\"><br>&nbsp;<br></div>";

            IList<string> expected = new List<string>();
            expected.Add("<img src=\"https://dev.azure.com/account/bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb/_apis/wit/attachments/aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa?fileName=temp1498074488622.png\" style=\"width:779.45px;\">");
        ...
        [TestMethod]
        public void GetAttachmentUrlGuid_ReturnsCorrectValueForProjectScopedUrl()
        {
            string url = "https://dev.azure.com/account/bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb/_apis/wit/attachments/aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa?fileName=temp149807448ZZZZ.png";
            Guid expected = new Guid("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa");
            Guid actual = MigrationHelpers.GetAttachmentUrlGuid(url);
            Assert.AreEqual(expected, actual);
        }
        ...
        [TestMethod]
        public void ReplaceAttachmentUrlGuid_ReplacesCorrectly()
        {
            string url = "https://dev.azure.com/account/WorkItemTracking/v1.0/AttachFileHandler.ashx?FileNameGuid=aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa&FileName=temp149807448ZZZZ.png";
        ...
        [TestMethod]
        public void ReplaceAttachmentUrlGuid_ReplacesCorrectlyForProjectScopedUrl()
        {
            string url = "https://dev.azure.com/account/bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb/_apis/wit/attachments/aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa?fileName=temp149807448ZZZZ.png";
            string newGuid = "bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb";
            string expected = "https://dev.azure.com/account/bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb/_apis/wit/attachments/bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb?fileName=temp149807448ZZZZ.png";
            string actual = MigrationHelpers.ReplaceAttachmentUrlGuid(url, newGuid);
            Assert.AreEqual(expected, actual);
        }
    }
